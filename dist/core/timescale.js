 ...
 */
export function position(config, T) {
 ...
 */
export function yearsBeforePresent(config, pos) {
    const base = config.logBase ?? 10;
    const anchor = config.anchorYearsBeforePresent;
    if (pos >= 0) {
 ...
 */
export function geologicalEpochAtPosition(pos) {
 ...
 */
export function politicalEpochAtPosition(pos) {
 ...
 */
export function geologicalEpochsInRange(posMin, posMax) {
 ...
 */
export function politicalEpochsInRange(posMin, posMax) {
